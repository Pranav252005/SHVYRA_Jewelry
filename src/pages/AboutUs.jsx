...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative pt-48 pb-24 lg:pb-32 bg-gradient-to-br from-[#E6B445] via-[#D4A574] to-[#C49A63]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 font-serif">
            About SHVYRA
          </h1>
          <p className="text-base sm:text-lg lg:text-xl text-white/90 max-w-8xl mx-auto leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-900 mb-6 font-serif">
                Our Mission
              </h2>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-900 mb-12 text-center font-serif">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
            <div className="md:col-span-2 bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 font-serif">Ethical Sourcing</h3>
            ...
            <div className="md:col-span-2 bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 font-serif">Timeless Design</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="md:col-span-2 bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 font-serif">Attention to Detail</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="md:col-span-2 md:col-start-2 bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 font-serif">Personal Connection</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="md:col-span-2 bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 font-serif">Modern Elegance</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2">Email Us</h3>
              <p className="text-sm sm:text-base text-gray-600">info@shvyra.com</p>
              <p className="text-sm sm:text-base text-gray-600">support@shvyra.com</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#E6B445] to-[#C49A63] rounded-full mb-4">
                <FiPhone size={28} className="text-white" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2">Call Us</h3>
              <p className="text-sm sm:text-base text-gray-600">+91 1800 123 4567</p>
              <p className="text-sm sm:text-base text-gray-600">Mon-Sat: 10AM - 7PM</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#E6B445] to-[#C49A63] rounded-full mb-4">
                <FiMapPin size={28} className="text-white" />
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2">Visit Us</h3>
              <p className="text-sm sm:text-base text-gray-600">123 Jewelry Lane</p>
              <p className="text-sm sm:text-base text-gray-600">Mumbai, India 400001</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-3">What is your return policy?</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-3">How do I care for my jewelry?</h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
